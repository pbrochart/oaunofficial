...
=================
*/
static void CG_DrawClientScoreOld( int y, score_t *score, float *color, float fade, qboolean largeFormat ) {
        char    string[1024];
        vec3_t  headAngles;
        clientInfo_t    *ci;
        int iconx, headx;
...
/*
=================
CG_TeamScoreboardOld
=================
*/
static int CG_TeamScoreboardOld( int y, team_t team, float fade, int maxClients, int lineHeight ) {
        int             i;
        score_t *score;
        float   color[4];
        int             count;
        ...
        for ( i = 0 ; i < cg.numScores && count < maxClients ; i++ ) {
                ...
                CG_DrawClientScoreOld( y + lineHeight * count, score, color, fade, lineHeight == SB_NORMAL_HEIGHT );
...
qboolean CG_DrawOldScoreboardOld( void ) {
        ...
        if ( cgs.gametype >= GT_TEAM && cgs.ffa_gt!=1) {
                ...
                if ( cg.teamScores[0] >= cg.teamScores[1] ) {
                        n1 = CG_TeamScoreboardOld( y, TEAM_RED, fade, maxClients, lineHeight );
                        CG_DrawTeamBackground( 0, y - topBorderSize, 640, n1 * lineHeight + bottomBorderSize, 0.33f, TEAM_RED );
                        y += (n1 * lineHeight) + BIGCHAR_HEIGHT;
                        maxClients -= n1;
                        n2 = CG_TeamScoreboardOld( y, TEAM_BLUE, fade, maxClients, lineHeight );
                        CG_DrawTeamBackground( 0, y - topBorderSize, 640, n2 * lineHeight + bottomBorderSize, 0.33f, TEAM_BLUE );
                        y += (n2 * lineHeight) + BIGCHAR_HEIGHT;
                        maxClients -= n2;
                } else {
                        n1 = CG_TeamScoreboardOld( y, TEAM_BLUE, fade, maxClients, lineHeight );
                        CG_DrawTeamBackground( 0, y - topBorderSize, 640, n1 * lineHeight + bottomBorderSize, 0.33f, TEAM_BLUE );
                        y += (n1 * lineHeight) + BIGCHAR_HEIGHT;
                        maxClients -= n1;
                        n2 = CG_TeamScoreboardOld( y, TEAM_RED, fade, maxClients, lineHeight );
                        CG_DrawTeamBackground( 0, y - topBorderSize, 640, n2 * lineHeight + bottomBorderSize, 0.33f, TEAM_RED );
                        y += (n2 * lineHeight) + BIGCHAR_HEIGHT;
                        maxClients -= n2;
                }
                n1 = CG_TeamScoreboardOld( y, TEAM_SPECTATOR, fade, maxClients, lineHeight );
                y += (n1 * lineHeight) + BIGCHAR_HEIGHT;
                ...
                //
                n1 = CG_TeamScoreboardOld( y, TEAM_FREE, fade, maxClients, lineHeight );
                y += (n1 * lineHeight) + BIGCHAR_HEIGHT;
                n2 = CG_TeamScoreboardOld( y, TEAM_SPECTATOR, fade, maxClients - n1, lineHeight );
                y += (n2 * lineHeight) + BIGCHAR_HEIGHT;
        }
        ...
        if (!localClient) {
                ...
                for ( i = 0 ; i < cg.numScores ; i++ ) {
                        if ( cg.scores[i].client == cg.snap->ps.clientNum ) {
                                CG_DrawClientScoreOld( y, &cg.scores[i], fadeColor, fade, lineHeight == SB_NORMAL_HEIGHT );
                                break;
                        }
                }
        }
