...
ifeq ($(PLATFORM),linux)
  ...
  OPTIMIZE = -ffast-math -funroll-loops -fomit-frame-pointer
...
ifeq ($(PLATFORM),freebsd)
  ...
  ifeq ($(ARCH),i386)
    RELEASE_CFLAGS=$(BASE_CFLAGS) -DNDEBUG -mtune=pentiumpro \
      -march=core2 -fomit-frame-pointer -pipe -ffast-math \
      -funroll-loops
#      -falign-loops=2 -falign-jumps=2 -falign-functions=2 \
